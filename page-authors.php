...
<section id="products" class="container">
	...
	<div class="row">
		...
		<?php $count = 0; while ($authorPosts->have_posts()) : $authorPosts->the_post();?>
		<?php if ($count != 0) {
			break;
		} ?>
	...
	<ul class="nav nav-tabs nav-justified nav-custom">		
	    ...
	    <?php $count = 0; $categories = get_terms(array('taxonomy'=>'author-category')); ?>
	...
	<div class="tab-content">
		...
		<?php $count = 0; $categories = get_categories(array('taxonomy'=>'author-category', 'number'=> 3)); ?>
